...
var consumerTask = Task.Run(async () =>
{
    ...
    await channel.QueueDeclareAsync("order_queue", durable: false, exclusive: false, autoDelete: false, arguments: null);
    await channel.QueueBindAsync("order_queue", "payment_exchange", "");
